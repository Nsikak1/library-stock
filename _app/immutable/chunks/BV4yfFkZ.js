import { t as M, U as Z, P as m, v as Q, j as T, E as ee, w as _, r as A, x as V } from "./wmqEO8lS.js";
import "./BGIauNhi.js";
class te {
  constructor(e) {
...
class P {
  constructor(e) {
    this.bubbles = true, this.cancelBubble = true, this.cancelable = false, this.composed = false, this.defaultPrevented = false, this.eventPhase = P.prototype.NONE, this.propagationStopped = false, this.propagationImmediatelyStopped = false, this.layer = new m(), this.page = new m(), this.NONE = 0, this.CAPTURING_PHASE = 1, this.AT_TARGET = 2, this.BUBBLING_PHASE = 3, this.manager = e;
  }
  get layerX() {
    return this.layer.x;
  }
...
var I = /iPhone/i, S = /iPod/i, C = /iPad/i, U = /\biOS-universal(?:.+)Mac\b/i, k = /\bAndroid(?:.+)Mobile\b/i, R = /Android/i, y = /(?:SD4930UR|\bSilk(?:.+)Mobile\b)/i, w = /Silk/i, v = /Windows Phone/i, X = /\bWindows(?:.+)ARM\b/i, Y = /BlackBerry/i, H = /BB10/i, F = /Opera Mini/i, N = /\b(CriOS|Chrome)(?:.+)Mobile/i, K = /Mobile(?:.+)Firefox\b/i, j = function(a) {
...
function $(a) {
  ...
  !a && typeof navigator < "u" ? e = { userAgent: navigator.userAgent, platform: navigator.platform, maxTouchPoints: navigator.maxTouchPoints || 0 } : typeof a == "string" ? e.userAgent = a : a && a.userAgent && (e = { userAgent: a.userAgent, platform: a.platform, maxTouchPoints: a.maxTouchPoints || 0 });
  var t = e.userAgent, i = t.split("[FBAN");
  typeof i[1] < "u" && (t = i[0]), i = t.split("Twitter"), typeof i[1] < "u" && (t = i[0]);
  var n = ie(t), s = { apple: { phone: n(I) && !n(v), ipod: n(S), tablet: !n(I) && (n(C) || j(e)) && !n(v), universal: n(U), device: (n(I) || n(S) || n(C) || n(U) || j(e)) && !n(v) }, amazon: { phone: n(y), tablet: !n(y) && n(w), device: n(y) || n(w) }, android: { phone: !n(v) && n(y) || !n(v) && n(k), tablet: !n(v) && !n(y) && !n(k) && (n(w) || n(R)), device: !n(v) && (n(y) || n(w) || n(k) || n(R)) || n(/\bokhttp\b/i) }, windows: { phone: n(v), tablet: n(X), device: n(v) || n(X) }, other: { blackberry: n(Y), blackberry10: n(H), opera: n(F), firefox: n(K), chrome: n(N), device: n(Y) || n(H) || n(F) || n(K) || n(N) }, any: false, phone: false, tablet: false };
...
const ne = $.default ?? $, se = ne(globalThis.navigator), oe = 9, G = 100, re = 0, ae = 0, W = 2, z = 1, he = -1e3, le = -1e3, ce = 2, B = class q {
  constructor(e, t = se) {
  ...
  _createTouchHook() {
    ...
    e.style.width = `${z}px`, e.style.height = `${z}px`, e.style.position = "absolute", e.style.top = `${he}px`, e.style.left = `${le}px`, e.style.zIndex = ce.toString(), e.style.backgroundColor = "#FF0000", e.title = "select to enable accessibility for this content", e.addEventListener("focus", () => {
  ...
  _deactivate() {
    ...
    if (!(!this._isActive || this._isMobileAccessibility)) {
      ...
      for (const e of this._children) ((_a = e._accessibleDiv) == null ? void 0 : _a.parentNode) && (e._accessibleDiv.parentNode.removeChild(e._accessibleDiv), e._accessibleDiv = null), e._accessibleActive = false;
      for (const e in this._pools) this._pools[e].forEach((i) => {
        i.parentNode && i.parentNode.removeChild(i);
      }), delete this._pools[e];
      ((_b = this._div) == null ? void 0 : _b.parentNode) && this._div.parentNode.removeChild(this._div), this._pools = {}, this._children = [];
    }
  }
  ...
  init(e) {
    const i = { accessibilityOptions: { ...q.defaultOptions, ...(e == null ? void 0 : e.accessibilityOptions) || {} } };
  ...
  postrender() {
    ...
    for (let i = this._children.length - 1; i >= 0; i--) {
      ...
      t.has(i) || (n._accessibleDiv && n._accessibleDiv.parentNode && (n._accessibleDiv.parentNode.removeChild(n._accessibleDiv), this._getPool(n.accessibleType).push(n._accessibleDiv), n._accessibleDiv = null), n._accessibleActive = false, Q(this._children, i, 1));
    }
  ...
  _dispatchEvent(e, t) {
    const { container: i } = e.target, n = this._renderer.events.rootBoundary, s = Object.assign(new P(n), { target: i });
...
B.defaultOptions = { enabledByDefault: false, debug: false, activateOnTab: true, deactivateOnMouseMove: true };
let de = B;
const ue = { accessible: false, accessibleTitle: null, accessibleHint: null, tabIndex: 0, accessibleType: "button", accessibleText: null, accessiblePointerEvents: "auto", accessibleChildren: true, _accessibleActive: false, _accessibleDiv: null, _renderId: -1 };
class pe {
  constructor() {
...
class O extends P {
  ...
  initMouseEvent(e, t, i, n, s, o, r, l, d, h, g, c, p, D, be) {
...
b.DOM_DELTA_LINE = 1;
b.DOM_DELTA_PAGE = 2;
const ve = 2048, fe = new m(), E = new m();
class me {
  constructor(e) {
    this.dispatch = new ee(), this.moveOnAll = false, this.enableGlobalMoveEvents = true, this.mappingState = { trackingData: {} }, this.eventPool = /* @__PURE__ */ new Map(), this._allInteractiveElements = [], this._hitElements = [], this._isPointerMoveEvent = false, this.rootTarget = e, this.hitPruneFn = this.hitPruneFn.bind(this), this.hitTestFn = this.hitTestFn.bind(this), this.mapPointerDown = this.mapPointerDown.bind(this), this.mapPointerMove = this.mapPointerMove.bind(this), this.mapPointerOut = this.mapPointerOut.bind(this), this.mapPointerOver = this.mapPointerOver.bind(this), this.mapPointerUp = this.mapPointerUp.bind(this), this.mapPointerUpOutside = this.mapPointerUpOutside.bind(this), this.mapWheel = this.mapWheel.bind(this), this.mappingTable = {}, this.addEventMapping("pointerdown", this.mapPointerDown), this.addEventMapping("pointermove", this.mapPointerMove), this.addEventMapping("pointerout", this.mapPointerOut), this.addEventMapping("pointerleave", this.mapPointerOut), this.addEventMapping("pointerover", this.mapPointerOver), this.addEventMapping("pointerup", this.mapPointerUp), this.addEventMapping("pointerupoutside", this.mapPointerUpOutside), this.addEventMapping("wheel", this.mapWheel);
  }
  addEventMapping(e, t) {
  ...
  hitTestMoveRecursive(e, t, i, n, s, o = false) {
    ...
    if ((e.eventMode === "dynamic" || t === "dynamic") && (f.pauseUpdate = false), e.interactiveChildren && e.children) {
      ...
      for (let g = h.length - 1; g >= 0; g--) {
        const c = h[g], p = this.hitTestMoveRecursive(c, this._isInteractive(t) ? t : c.eventMode, i, n, s, o || s(e, i));
        if (p) {
  ...
  hitTestRecursive(e, t, i, n, s) {
    ...
    if ((e.eventMode === "dynamic" || t === "dynamic") && (f.pauseUpdate = false), e.interactiveChildren && e.children) {
      ...
      for (let h = l.length - 1; h >= 0; h--) {
        const g = l[h], c = this.hitTestRecursive(g, this._isInteractive(t) ? t : g.eventMode, d, n, s);
        if (c) {
  ...
  mapPointerUp(e) {
    ...
    if (o) {
      ...
      r.target = o, r.path = null, n.clicksByButton[e.button] || (n.clicksByButton[e.button] = { clickCount: 0, target: r.target, timeStamp: t });
...
const ge = 1, _e = { touchstart: "pointerdown", touchend: "pointerup", touchendoutside: "pointerupoutside", touchmove: "pointermove", touchcancel: "pointercancel" }, L = class x {
  constructor(e) {
    this.supportsTouchEvents = "ontouchstart" in globalThis, this.supportsPointerEvents = !!globalThis.PointerEvent, this.domElement = null, this.resolution = 1, this.renderer = e, this.rootBoundary = new me(null), f.init(this), this.autoPreventDefault = true, this._eventsAdded = false, this._rootPointerEvent = new u(null), this._rootWheelEvent = new b(null), this.cursorStyles = { default: "inherit", pointer: "pointer" }, this.features = new Proxy({ ...x.defaultEventFeatures }, { set: (t, i, n) => (i === "globalMove" && (this.rootBoundary.enableGlobalMoveEvents = n), t[i] = n, true) }), this._onPointerDown = this._onPointerDown.bind(this), this._onPointerMove = this._onPointerMove.bind(this), this._onPointerUp = this._onPointerUp.bind(this), this._onPointerOverOut = this._onPointerOverOut.bind(this), this.onWheel = this.onWheel.bind(this);
  }
  ...
  _bootstrapEvent(e, t) {
    return e.originalEvent = null, e.nativeEvent = t, e.pointerId = t.pointerId, e.width = t.width, e.height = t.height, e.isPrimary = t.isPrimary, e.pointerType = t.pointerType, e.pressure = t.pressure, e.tangentialPressure = t.tangentialPressure, e.tiltX = t.tiltX, e.tiltY = t.tiltY, e.twist = t.twist, this._transferMouseData(e, t), this.mapPositionToPoint(e.screen, t.clientX, t.clientY), e.global.copyFrom(e.screen), e.offset.copyFrom(e.screen), e.isTrusted = t.isTrusted, e.type === "pointerleave" && (e.type = "pointerout"), e.type.startsWith("mouse") && (e.type = e.type.replace("mouse", "pointer")), e.type.startsWith("touch") && (e.type = _e[e.type] || e.type), e;
  }
...
L.extension = { name: "events", type: [T.WebGLSystem, T.CanvasSystem, T.WebGPUSystem], priority: -1 };
L.defaultEventFeatures = { move: true, globalMove: true, click: true, wheel: true };
let J = L;
...
}, interactiveChildren: true, hitArea: null, addEventListener(a, e, t) {
