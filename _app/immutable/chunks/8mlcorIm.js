import { S as n, a as u, G as o, b as f } from "./wmqEO8lS.js";
const s = class i extends n {
  ...
  static from(e) {
    ...
    let l, d;
    return t && (l = o.from(t)), a && (d = f.from(a)), new i({ gpuProgram: l, glProgram: d, ...r });
  }
};
s.defaultOptions = { blendMode: "normal", resolution: 1, padding: 0, antialias: "off", blendRequired: false, clipToViewport: true };
let b = s;
export {
  b as F
};
