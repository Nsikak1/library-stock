import { w as U, g, d as c, u as S, B as _, e as m, E as I, f as p } from "./wmqEO8lS.js";
...
const d = [];
d[c.NONE] = void 0;
d[c.DISABLED] = { stencilWriteMask: 0, stencilReadMask: 0 };
d[c.RENDERING_MASK_ADD] = { stencilFront: { compare: "equal", passOp: "increment-clamp" }, stencilBack: { compare: "equal", passOp: "increment-clamp" } };
d[c.RENDERING_MASK_REMOVE] = { stencilFront: { compare: "equal", passOp: "decrement-clamp" }, stencilBack: { compare: "equal", passOp: "decrement-clamp" } };
d[c.MASK_ACTIVE] = { stencilWriteMask: 0, stencilFront: { compare: "equal", passOp: "keep" }, stencilBack: { compare: "equal", passOp: "keep" } };
d[c.INVERSE_MASK_ACTIVE] = { stencilWriteMask: 0, stencilFront: { compare: "not-equal", passOp: "keep" }, stencilBack: { compare: "not-equal", passOp: "keep" } };
class B {
  constructor(t) {
  ...
  ensureUniformGroup(t) {
    ...
    t.buffer || (t.buffer = new _({ data: new Float32Array(a.layout.size / 4), usage: m.UNIFORM | m.COPY_DST }));
  }
  ...
  _initUniformGroup(t) {
    ...
    if (!s) {
      ...
      s = this._syncFunctionHash[a] = { layout: n, syncFunction: o };
    }
  ...
  syncUniformGroup(t, a, s) {
    ...
    t.buffer || (t.buffer = new _({ data: new Float32Array(r.layout.size / 4), usage: m.UNIFORM | m.COPY_DST }));
    let n = null;
    return a || (a = t.buffer.data, n = t.buffer.dataInt32), s || (s = 0), r.syncFunction(t.uniforms, a, n, s), true;
  }
...
const h = [{ type: "mat3x3<f32>", test: (e) => e.value.a !== void 0, ubo: `
...
function k(e, t, a, s) {
  ...
  for (let l = 0; l < e.length; l++) {
    ...
    let y = false, i = 0;
    for (let u = 0; u < h.length; u++) if (h[u].test(f.data)) {
      i = f.offset / 4, r.push(`name = "${b}";`, `offset += ${i - n};`, h[u][t] || h[u].ubo), y = true;
      break;
    }
...
class P extends I {
  constructor({ buffer: t, offset: a, size: s }) {
    super(), this.uid = p("buffer"), this._resourceType = "bufferResource", this._touched = 0, this._resourceId = p("resource"), this._bufferResource = true, this.destroyed = false, this.buffer = t, this.offset = a | 0, this.size = s, this.buffer.on("change", this.onBufferChange, this);
  }
  onBufferChange() {
    this._resourceId = p("resource"), this.emit("change", this);
  }
  destroy(t = false) {
    this.destroyed = true, t && this.buffer.destroy(), this.emit("change", this), this.buffer = null, this.removeAllListeners();
  }
}
export {
  P as B,
