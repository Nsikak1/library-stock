import { a4 as Ve, $ as oe, M as m, G as Ne, b as je, a as $e, a5 as le, j as l, r as W, a6 as w, a7 as qe, a8 as z, a9 as T, R as V, aa as de, ab as Ke, T as f, d as g, Z as D, w as ue, ac as ee, ad as ce, ae as he, af as pe, ag as fe, x as P, K as Ye, C as E, D as N, _ as y, L as B, ah as Je, P as Xe, ai as Qe, X as Ze, t as te, aj as re, I as p, f as et, q as O, c as tt, J as rt, ak as st, al as nt } from "./wmqEO8lS.js";
import { F as at } from "./8mlcorIm.js";
...
class lt extends at {
  constructor(e) {
    const { sprite: t, ...r } = e, s = new Ve(t.texture), n = new oe({ uFilterMatrix: { value: new m(), type: "mat3x3<f32>" }, uMaskClamp: { value: s.uClampFrame, type: "vec4<f32>" }, uAlpha: { value: 1, type: "f32" }, uInverse: { value: e.inverse ? 1 : 0, type: "f32" } }), i = Ne.from({ vertex: { source: se, entryPoint: "mainVertex" }, fragment: { source: se, entryPoint: "mainFragment" } }), o = je.from({ vertex: ot, fragment: it, name: "mask-filter" });
    super({ ...r, gpuProgram: i, glProgram: o, clipToViewport: false, resources: { filterUniforms: n, uMaskTexture: t.texture.source } }), this.sprite = t, this._textureMatrix = s;
  }
  set inverse(e) {
...
const j = class ge {
  constructor(e, t) {
    var _a, _b;
    this.state = $e.for2d(), this._batchersByInstructionSet = /* @__PURE__ */ Object.create(null), this._activeBatches = /* @__PURE__ */ Object.create(null), this.renderer = e, this._adaptor = t, (_b = (_a = this._adaptor).init) == null ? void 0 : _b.call(_a, this);
  }
  static getBatcher(e) {
  ...
  buildStart(e) {
    ...
    t || (t = this._batchersByInstructionSet[e.uid] = /* @__PURE__ */ Object.create(null), t.default || (t.default = new le({ maxTextures: this.renderer.limits.maxBatchableTextures }))), this._activeBatches = t, this._activeBatch = this._activeBatches.default;
...
j.extension = { type: [l.WebGLPipes, l.WebGPUPipes, l.CanvasPipes], name: "batch" };
...
class ut extends de {
  constructor() {
    super(), this.filters = [new lt({ sprite: new Ke(f.EMPTY), inverse: false, resolution: "inherit", antialias: "inherit" })];
  }
  get sprite() {
...
class xe {
  ...
  push(e, t, r) {
    ...
    if (s.renderPipes.batch.break(r), r.add({ renderPipeId: "alphaMask", action: "pushMaskBegin", mask: e, inverse: t._maskOptions.inverse, canBundle: false, maskedContainer: t }), e.inverse = t._maskOptions.inverse, e.renderMaskToTexture) {
      const n = e.mask;
      n.includeInBuild = true, n.collectRenderables(r, s, null), n.includeInBuild = false;
    }
    s.renderPipes.batch.break(r), r.add({ renderPipeId: "alphaMask", action: "pushMaskEnd", mask: e, maskedContainer: t, inverse: t._maskOptions.inverse, canBundle: false });
  }
  pop(e, t, r) {
    this._renderer.renderPipes.batch.break(r), r.add({ renderPipeId: "alphaMask", action: "popMaskEnd", mask: e, inverse: t._maskOptions.inverse, canBundle: false });
  }
  execute(e) {
    ...
    if (e.action === "pushMaskBegin") {
      ...
      if (s.inverse = e.inverse, r) {
        ...
        const n = qe(e.mask.mask, true, dt);
        e.mask.mask.measurable = false, n.ceil();
        const i = t.renderTarget.renderTarget.colorTexture.source, o = T.getOptimalTexture(n.width, n.height, i._resolution, i.antialias);
        t.renderTarget.push(o, true), t.globalUniforms.push({ offset: n, worldColor: 4294967295 });
        const d = s.sprite;
        d.texture = o, d.worldTransform.tx = n.minX, d.worldTransform.ty = n.minY, this._activeMaskStage.push({ filterEffect: s, maskedContainer: e.maskedContainer, filterTexture: o });
      } else s.sprite = e.mask.mask, this._activeMaskStage.push({ filterEffect: s, maskedContainer: e.maskedContainer });
    } else if (e.action === "pushMaskEnd") {
      const s = this._activeMaskStage[this._activeMaskStage.length - 1];
      r && (t.type === V.WEBGL && t.renderTarget.finishRenderPass(), t.renderTarget.pop(), t.globalUniforms.pop()), t.filter.push({ renderPipeId: "filter", action: "pushFilter", container: s.maskedContainer, filterEffect: s.filterEffect, canBundle: false });
...
xe.extension = { type: [l.WebGLPipes, l.WebGPUPipes, l.CanvasPipes], name: "alphaMask" };
class be {
  constructor(e) {
  ...
  push(e, t, r) {
    ...
    i !== this._currentColor && (this._currentColor = i, r.add({ renderPipeId: "colorMask", colorMask: i, canBundle: false })), this._colorStackIndex++;
  }
  pop(e, t, r) {
    this._renderer.renderPipes.batch.break(r);
    const n = this._colorStack;
    ...
    i !== this._currentColor && (this._currentColor = i, r.add({ renderPipeId: "colorMask", colorMask: i, canBundle: false }));
  }
  execute(e) {
...
be.extension = { type: [l.WebGLPipes, l.WebGPUPipes], name: "colorMask" };
class Te {
  constructor(e) {
  ...
  push(e, t, r) {
    ...
    i.renderPipes.batch.break(r), i.renderPipes.blendMode.setBlendMode(n.mask, "none", r), r.add({ renderPipeId: "stencilMask", action: "pushMaskBegin", mask: e, inverse: t._maskOptions.inverse, canBundle: false });
    const o = n.mask;
    o.includeInBuild = true, this._maskHash.has(n) || this._maskHash.set(n, { instructionsStart: 0, instructionsLength: 0 });
    const d = this._maskHash.get(n);
    d.instructionsStart = r.instructionSize, o.collectRenderables(r, i, null), o.includeInBuild = false, i.renderPipes.batch.break(r), r.add({ renderPipeId: "stencilMask", action: "pushMaskEnd", mask: e, inverse: t._maskOptions.inverse, canBundle: false });
    const c = r.instructionSize - d.instructionsStart - 1;
    d.instructionsLength = c;
    const u = i.renderTarget.renderTarget.uid;
    (s = this._maskStackHash)[u] ?? (s[u] = 0);
  }
  pop(e, t, r) {
    const s = e, n = this._renderer;
    n.renderPipes.batch.break(r), n.renderPipes.blendMode.setBlendMode(s.mask, "none", r), r.add({ renderPipeId: "stencilMask", action: "popMaskBegin", inverse: t._maskOptions.inverse, canBundle: false });
...
Te.extension = { type: [l.WebGLPipes, l.WebGPUPipes], name: "stencilMask" };
class ye {
  constructor(e) {
    this._renderer = e;
  }
...
ye.extension = { type: [l.WebGLPipes, l.WebGPUPipes, l.CanvasPipes], name: "customRender" };
function L(a, e) {
...
class ve {
  ...
  _executeCacheAsTexture(e) {
    if (e.textureNeedsUpdate) {
      ...
      this._renderer.renderTarget.push(e.texture, true, null, e.texture.frame), this._renderer.globalUniforms.push({ worldTransformMatrix: t, worldColor: 4294967295, offset: { x: 0, y: 0 } }), L(e, this._renderer.renderPipes), this._renderer.renderTarget.finishRenderPass(), this._renderer.renderTarget.pop(), this._renderer.globalUniforms.pop();
    }
  ...
  _executeDirect(e) {
    this._renderer.globalUniforms.push({ worldTransformMatrix: e.inverseParentTextureTransform, worldColor: e.worldColorAlpha }), L(e, this._renderer.renderPipes), this._renderer.globalUniforms.pop();
  }
}
ve.extension = { type: [l.WebGLPipes, l.WebGPUPipes, l.CanvasPipes], name: "renderGroup" };
class Ce {
  constructor(e) {
    this._renderer = e;
  }
...
Ce.extension = { type: [l.WebGLPipes, l.WebGPUPipes, l.CanvasPipes], name: "sprite" };
const v = {};
...
class ke {
  ...
  _beginAdvancedBlendMode(e, t) {
    ...
    const s = this._ensureFilterEffect(r), n = e instanceof ee, i = { renderPipeId: "filter", action: "pushFilter", filterEffect: s, renderables: n ? null : [e], container: n ? e.root : null, canBundle: false };
  ...
  _endAdvancedBlendMode(e) {
    this._isAdvanced = false, this._renderableList = null, this._renderer.renderPipes.batch.break(e), e.add({ renderPipeId: "filter", action: "popFilter", canBundle: false });
  }
  buildStart() {
...
ke.extension = { type: [l.WebGLPipes, l.WebGPUPipes, l.CanvasPipes], name: "blendMode" };
function F(a, e) {
  e || (e = 0);
...
function Me(a, e = false) {
  ...
  for (const s in t) {
    ...
    for (let c = 0; c < d; c++) {
      const u = o[c];
      u.parentRenderGroup === a && u.relativeRenderGroupDepth === n && Se(u, r, 0);
    }
    F(o, d), i.index = 0;
  }
  if (e) for (let s = 0; s < a.renderGroupChildren.length; s++) Me(a.renderGroupChildren[s], e);
}
function ht(a) {
  const e = a.root;
  let t;
  ...
  _updateCachedRenderGroups(e, t) {
    ...
    if (e.invalidateMatrices(), e.isCachedAsTexture) {
      if (e.textureNeedsUpdate) {
        ...
        r.ceil(), e.texture && T.returnTexture(e.texture, true);
        const c = T.getOptimalTexture(r.width, r.height, n, i);
        c._source.style = new Ye({ scaleMode: o }), e.texture = c, e._textureBounds || (e._textureBounds = new z()), e._textureBounds.copyFrom(r), d !== e.texture && e.renderGroupParent && (e.renderGroupParent.structureDidChange = true);
      }
    } else e.texture && (T.returnTexture(e.texture, true), e.texture = null);
  }
  _updateRenderGroups(e) {
    const t = this._renderer, r = t.renderPipes;
    if (e.runOnRender(t), e.instructionSet.renderPipes = r, e.structureDidChange ? F(e.childrenRenderablesToUpdate.list, 0) : pt(e, r), Me(e), e.structureDidChange ? (e.structureDidChange = false, this._buildInstructions(e, t)) : this._updateRenderables(e), e.childrenRenderablesToUpdate.index = 0, t.renderPipes.batch.upload(e.instructionSet), !(e.isCachedAsTexture && !e.textureNeedsUpdate)) for (let s = 0; s < e.renderGroupChildren.length; s++) this._updateRenderGroups(e.renderGroupChildren[s]);
  }
...
Re.extension = { type: [l.WebGLSystem, l.WebGPUSystem, l.CanvasSystem], name: "renderGroup" };
const $ = class we {
  constructor() {
    this.clearBeforeRender = true, this._backgroundColor = new E(0), this.color = this._backgroundColor, this.alpha = 1;
  }
  init(e) {
  ...
  set color(e) {
    E.shared.setValue(e).alpha < 1 && this._backgroundColor.alpha === 1 && ue("Cannot set a transparent background on an opaque canvas. To enable transparency, set backgroundAlpha < 1 when initializing your Application."), this._backgroundColor.setValue(e);
  }
  get alpha() {
...
$.extension = { type: [l.WebGLSystem, l.WebGPUSystem, l.CanvasSystem], name: "background", priority: 0 };
$.defaultOptions = { backgroundAlpha: 1, backgroundColor: 0, clearBeforeRender: true };
let mt = $;
const I = { png: "image/png", jpg: "image/jpeg", webp: "image/webp" }, q = class Pe {
  constructor(e) {
    this._renderer = e;
  }
  _normalizeOptions(e, t = {}) {
    return e instanceof P || e instanceof f ? { target: e, ...t } : { ...t, ...e };
  }
  async image(e) {
  ...
  canvas(e) {
    ...
    if (t instanceof f) return r.texture.generateCanvas(t);
  ...
  log(e) {
    ...
    const n = ["font-size: 1px;", `padding: ${t}px 300px;`, `background: url(${s}) no-repeat;`, "background-size: contain;"].join(" ");
    console.log("%c ", n);
  }
  destroy() {
    this._renderer = null;
...
q.extension = { type: [l.WebGLSystem, l.WebGPUSystem, l.CanvasSystem], name: "extract" };
q.defaultImageOptions = { format: "png", quality: 1 };
let gt = q;
class K extends f {
  static create(e) {
    const { dynamic: t, ...r } = e;
    return new K({ source: new y(r), dynamic: t ?? false });
  }
  resize(e, t, r) {
...
class Be {
  ...
  generateTexture(e) {
    var _a;
    e instanceof P && (e = { target: e, frame: void 0, textureSourceOptions: {}, resolution: void 0 });
    ...
    const i = ((_a = e.frame) == null ? void 0 : _a.copyTo(_t)) || Je(s, xt).rectangle;
    i.width = Math.max(i.width, 1 / t) | 0, i.height = Math.max(i.height, 1 / t) | 0;
    const o = K.create({ ...e.textureSourceOptions, width: i.width, height: i.height, resolution: t, antialias: r }), d = m.shared.translate(-i.x, -i.y);
    return this._renderer.render({ container: s, transform: d, target: o, clearColor: n }), o.source.updateMipmaps(), o;
  }
  destroy() {
    this._renderer = null;
  }
}
Be.extension = { type: [l.WebGLSystem, l.WebGPUSystem, l.CanvasSystem], name: "textureGenerator" };
function Tt(a) {
  let e = false;
...
const Y = class Ge {
  constructor(e) {
    this._managedResources = [], this._managedResourceHashes = [], this._managedCollections = [], this._ready = false, this._renderer = e;
  }
  init(e) {
  ...
  set enabled(e) {
    this.enabled !== e && (e ? (this._handler = this._renderer.scheduler.repeat(() => {
      this._ready = true;
    }, this._frequency, false), this._collectionsHandler = this._renderer.scheduler.repeat(() => {
  ...
  postrender() {
    !this._ready || !this.enabled || (this.run(), this._ready = false);
  }
  ...
  addCollection(e, t, r) {
    this._managedCollections.push({ context: e, collection: t, type: r });
  }
  addResource(e, t) {
    var _a, _b;
    if (e._gcLastUsed !== -1) {
      e._gcLastUsed = this.now, (_a = e._onTouch) == null ? void 0 : _a.call(e, this.now);
      return;
    }
    const r = this._managedResources.length;
    e._gcData = { index: r, type: t }, e._gcLastUsed = this.now, (_b = e._onTouch) == null ? void 0 : _b.call(e, this.now), e.once("unload", this.removeResource, this), this._managedResources.push(e);
  }
  removeResource(e) {
    const t = e._gcData;
    if (!t) return;
  ...
  addResourceHash(e, t, r, s = 0) {
    this._managedResourceHashes.push({ context: e, hash: t, type: r, priority: s }), this._managedResourceHashes.sort((n, i) => n.priority - i.priority);
  }
  run() {
  ...
  updateRenderableGCTick(e, t) {
    var _a, _b;
    const r = e.renderGroup ?? e.parentRenderGroup, s = ((_a = r == null ? void 0 : r.instructionSet) == null ? void 0 : _a.gcTick) ?? -1;
    ((r == null ? void 0 : r.gcTick) ?? 0) === s && (e._gcLastUsed = t, (_b = e._onTouch) == null ? void 0 : _b.call(e, t));
  }
  runOnResource(e, t, r) {
    const s = e._gcData;
  ...
  runOnHash(e, t) {
    ...
    for (const c in i) {
      ...
      if (u._gcLastUsed === -1) {
        u._gcLastUsed = t, (_a = u._onTouch) == null ? void 0 : _a.call(u, t), o && (o[c] = u);
        continue;
      }
      if (n === "renderable" && this.updateRenderableGCTick(u, t), !(t - u._gcLastUsed < this.maxUnusedTime) && u.autoGarbageCollect) {
        if (o || (d + 1 !== 1e4 ? (i[c] = null, d++) : o = this._createHashClone(i, c)), n === "renderable") {
          const b = u, _ = b.renderGroup ?? b.parentRenderGroup;
          _ && (_.structureDidChange = true);
        }
  ...
  destroy() {
    this.enabled = false, this._managedResources.forEach((e) => {
...
Y.extension = { type: [l.WebGLSystem, l.WebGPUSystem, l.CanvasSystem], name: "gc", priority: 0 };
Y.defaultOptions = { gcActive: true, gcMaxUnusedTime: 6e4, gcFrequency: 3e4 };
let vt = Y;
class Ue {
  constructor(e) {
  ...
  bind({ size: e, projectionMatrix: t, worldTransformMatrix: r, worldColor: s, offset: n }) {
    const i = this._renderer.renderTarget.renderTarget, o = this._stackIndex ? this._globalUniformDataStack[this._stackIndex - 1] : { worldTransformMatrix: new m(), worldColor: 4294967295, offset: new Xe() }, d = { projectionMatrix: t || this._renderer.renderTarget.projectionMatrix, resolution: e || i.size, worldTransformMatrix: r || o.worldTransformMatrix, worldColor: s || o.worldColor, offset: n || o.offset, bindGroup: null }, c = this._uniformsPool.pop() || this._createUniforms();
    this._activeUniforms.push(c);
    const u = c.uniforms;
    u.uProjectionMatrix = d.projectionMatrix, u.uResolution = d.resolution, u.uWorldTransformMatrix.copyFrom(d.worldTransformMatrix), u.uWorldTransformMatrix.tx -= d.offset.x, u.uWorldTransformMatrix.ty -= d.offset.y, Qe(d.worldColor, u.uWorldColorAlpha, 0), c.update();
    let h;
    this._renderer.renderPipes.uniformBatch ? h = this._renderer.renderPipes.uniformBatch.getUniformBindGroup(c, false) : (h = this._bindGroupPool.pop() || new Ze(), this._activeBindGroups.push(h), h.setResource(c, 0)), d.bindGroup = h, this._currentGlobalUniformData = d;
  }
  push(e) {
  ...
  _createUniforms() {
    return new oe({ uProjectionMatrix: { value: new m(), type: "mat3x3<f32>" }, uWorldTransformMatrix: { value: new m(), type: "mat3x3<f32>" }, uWorldColorAlpha: { value: new Float32Array(4), type: "vec4<f32>" }, uResolution: { value: [0, 0], type: "vec2<f32>" } }, { isStatic: true });
  }
  destroy() {
...
Ue.extension = { type: [l.WebGLSystem, l.WebGPUSystem, l.CanvasSystem], name: "globalUniforms" };
let Ct = 1;
class Ae {
  constructor() {
  ...
  repeat(e, t, r = true) {
    const s = Ct++;
    let n = 0;
    return r && (this._offset += 1e3, n = this._offset), this._tasks.push({ func: e, duration: t, start: performance.now(), offset: n, last: performance.now(), repeat: true, id: s }), s;
  }
  cancel(e) {
...
Ae.extension = { type: [l.WebGLSystem, l.WebGPUSystem, l.CanvasSystem], name: "scheduler", priority: 0 };
let ie = false;
function kt(a) {
  if (!ie) {
...
J.extension = { type: [l.WebGLSystem, l.WebGPUSystem, l.CanvasSystem], name: "hello", priority: -2 };
J.defaultOptions = { hello: false };
const X = class Ie {
  constructor(e) {
    this._renderer = e;
  }
...
X.extension = { type: [l.WebGLSystem, l.WebGPUSystem, l.CanvasSystem], name: "renderableGC", priority: 0 };
X.defaultOptions = { renderableGCActive: true, renderableGCMaxUnusedTime: 6e4, renderableGCFrequency: 3e4 };
let Mt = X;
const Q = class R {
  get count() {
...
Q.extension = { type: [l.WebGLSystem, l.WebGPUSystem], name: "textureGC" };
Q.defaultOptions = { textureGCActive: true, textureGCAMaxIdle: null, textureGCMaxIdle: 3600, textureGCCheckCountMax: 600 };
let St = Q;
const De = class Ee {
  constructor(e = {}) {
    if (this.uid = et("renderTarget"), this.colorTextures = [], this.dirtyId = 0, this.isRoot = false, this._size = new Float32Array(2), this._managedColorTextures = false, e = { ...Ee.defaultOptions, ...e }, this.stencil = e.stencil, this.depth = e.depth, this.isRoot = e.isRoot, typeof e.colorTextures == "number") {
      this._managedColorTextures = true;
      for (let t = 0; t < e.colorTextures; t++) this.colorTextures.push(new y({ width: e.width, height: e.height, resolution: e.resolution, antialias: e.antialias }));
    } else {
  ...
  ensureDepthStencilTexture() {
    this.depthStencilTexture || (this.depthStencilTexture = new y({ width: this.width, height: this.height, resolution: this.resolution, format: "depth24plus-stencil8", autoGenerateMipmaps: false, antialias: false, mipLevelCount: 1 }));
  }
...
De.defaultOptions = { width: 0, height: 0, resolution: 1, colorTextures: 1, stencil: false, depth: false, antialias: false, isRoot: false };
let H = De;
const x = /* @__PURE__ */ new Map();
tt.register(x);
function Oe(a, e) {
  if (!x.has(a)) {
    const t = new f({ source: new O({ resource: a, ...e }) }), r = () => {
...
const Z = class Le {
  ...
  init(e) {
    e = { ...Le.defaultOptions, ...e }, e.view && (p(rt, "ViewSystem.view has been renamed to ViewSystem.canvas"), e.canvas = e.view), this.screen = new B(0, 0, e.width, e.height), this.canvas = e.canvas || N.get().createCanvas(), this.antialias = !!e.antialias, this.texture = Oe(this.canvas, e), this.renderTarget = new H({ colorTextures: [this.texture], depth: !!e.depth, isRoot: true }), this.texture.source.transparent = e.backgroundAlpha < 1, this.resolution = e.resolution;
  }
  resize(e, t, r) {
...
Z.extension = { type: [l.WebGLSystem, l.WebGPUSystem, l.CanvasSystem], name: "view", priority: 0 };
Z.defaultOptions = { width: 800, height: 600, autoDensity: false, antialias: false };
let Rt = Z;
const Ut = [mt, Ue, J, Rt, Re, vt, St, Be, gt, st, Mt, Ae], At = [ke, _e, Ce, ve, xe, Te, be, ye];
...
class It {
  ...
  renderStart({ target: e, clear: t, clearColor: r, frame: s, mipLevel: n, layer: i }) {
    var _a, _b;
    this._renderTargetStack.length = 0, this.push(e, t, r, s, n ?? 0, i ?? 0), this.rootViewPort.copyFrom(this.viewport), this.rootRenderTarget = this.renderTarget, this.renderingToScreen = Pt(this.rootRenderTarget), (_b = (_a = this.adaptor).prerender) == null ? void 0 : _b.call(_a, this.rootRenderTarget);
  }
  postrender() {
    var _a, _b;
    (_b = (_a = this.adaptor).postrender) == null ? void 0 : _b.call(_a, this.rootRenderTarget);
  }
  bind(e, t = true, r, s, n = 0, i = 0) {
    ...
    const u = o.colorTexture, h = this.viewport, b = u.arrayLayerCount || 1;
    if ((i | 0) !== i && (i |= 0), i < 0 || i >= b) throw new Error(`[RenderTargetSystem] layer ${i} is out of bounds (arrayLayerCount=${b}).`);
    this.mipLevel = n | 0, this.layer = i | 0;
    const _ = Math.max(u.pixelWidth >> n, 1), G = Math.max(u.pixelHeight >> n, 1);
    if (!s && e instanceof f && (s = e.frame), s) {
      const C = u._resolution, k = 1 << Math.max(n | 0, 0), Fe = s.x * C + 0.5 | 0, He = s.y * C + 0.5 | 0, We = s.width * C + 0.5 | 0, ze = s.height * C + 0.5 | 0;
      let M = Math.floor(Fe / k), S = Math.floor(He / k), U = Math.ceil(We / k), A = Math.ceil(ze / k);
      M = Math.min(Math.max(M, 0), _ - 1), S = Math.min(Math.max(S, 0), G - 1), U = Math.min(Math.max(U, 1), _ - M), A = Math.min(Math.max(A, 1), G - S), h.x = M, h.y = S, h.width = U, h.height = A;
  ...
  push(e, t = D.ALL, r, s, n = 0, i = 0) {
    ...
    return this._renderTargetStack.push({ renderTarget: o, frame: s, mipLevel: n, layer: i }), o;
  }
  pop() {
    this._renderTargetStack.pop();
    const e = this._renderTargetStack[this._renderTargetStack.length - 1];
    this.bind(e.renderTarget, false, null, e.frame, e.mipLevel, e.layer);
  }
  getRenderTarget(e) {
  ...
  ensureDepthStencil() {
    this.renderTarget.stencil || (this.renderTarget.stencil = true, this.adaptor.startRenderPass(this.renderTarget, false, null, this.viewport, 0, this.layer));
  }
  destroy() {
  ...
  _initRenderTarget(e) {
    let t = null;
    return O.test(e) && (e = Oe(e).source), e instanceof H ? t = e : e instanceof y && (t = new H({ colorTextures: [e] }), e.source instanceof O && (t.isRoot = true), e.once("destroy", () => {
